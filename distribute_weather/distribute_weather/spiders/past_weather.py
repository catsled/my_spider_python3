...
import scrapy
import time
from distribute_weather.items import DistributeWeatherItem
from scrapy_redis.spiders import RedisSpider

class PastWeatherSpider(RedisSpider):
    name = 'past_weather'
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.allowed_domains = list(filter(None, domain))
        super(PastWeatherSpider, self).__init__(*args, **kwargs)
